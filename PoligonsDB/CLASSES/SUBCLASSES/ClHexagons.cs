...
namespace PoligonsDB.CLASSES.SUBCLASSES
{
    internal class ClHexagons : ClPoligons
    {
        ...
        public ClHexagons(ClBd xbd, string xnom, double xlado, double xapotema, double xarea, double xperimetre, int xcolor) : base(xbd, xnom, xlado, xapotema, xarea, xperimetre, xcolor)
        {
            String xsql = $"INSERT INTO Hexagons (id_Poligon, nom, lado, apotema, area, perimetre, color)  VALUES({id_Poligon}, {xnom}, {xlado}, {xapotema}, {xarea}, {xperimetre}, {xcolor})";
